...
public class Print extends JFrame implements ActionListener{
	...
	public void Print(){
		...
		closeB.setActionCommand("Close Print Window");
	...
	public void actionPerformed(ActionEvent e){
		...
		if(actionCommand.equals("Print Selected")) {
			...
			PopUpWindow popUpGuiPrint = new PopUpWindow("Table saved to file!");
		} else if(actionCommand.equals("Close Print Window")) { pWindow.dispose(); }
	}
}