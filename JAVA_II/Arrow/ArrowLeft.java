...
public class ArrowLeft extends ShapeBasics
{
	...
	public ArrowLeft(int theOffset, int theLength, int theWidth)
	{
		super(theOffset);
		length = theLength;
		width = theWidth;
	...
	public void drawTop()
	{
		...
		int position = getOffset() + lineCount * 2;
		int count;
		int emptySpaces = 1;
