/*
 ...
 Project # 2
 Due: April 29, 2015
 User puts in five numbers and those numbers are compared with five randomly generated numbers.
*/
import javax.swing.*;
import java.awt.*;
...
public class LotteryNumbers extends JFrame implements ActionListener
{
	...
	public LotteryNumbers()
	{
		...
		userPickPanel.setBackground(Color.white);
		...
		randomNumPanel.setBackground(Color.white);
		...
		matchDisplay.setBackground(Color.white);
		...
		prizeDisplay.setBackground(Color.white);
